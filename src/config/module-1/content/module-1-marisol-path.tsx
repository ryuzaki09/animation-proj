...
export const module1MarisolPathContent: Module1PathI = {
  scenario1: {
    section1: {
      ...
      content: (
        <div className="container">
          <p>
            Marisol García is 34 and lives in Brooklyn with her two kids. She works at a bakery <span className="visual-break" />
            and her income is around $75,000/year. She is currently renting a small two-bedroom <span className="visual-break" />
            apartment with her two kids, Mateo and Sofia. She struggles with rising rent, has some <span className="visual-break" />
            savings but not enough for a home; her Uncle Javier is willing to help her by giving a <span className="visual-break" />
            gift for downpayment and/or closing costs, offering a bit of hope for the future.
          </p>
        </div>
      ),
    ...
    section3: {
      ...
      content: (
        <>
          <h2>
            <span>8am</span> <span>Marisol's morning</span>
          </h2>
        </>
      ),
      image: assets.scenario1Bg2,
    },
    section4: {
      sectionTitle: "Internet Access and Education",
      content: {
        title: <h3 className="headingTitleSmall">Let's place yourself in Marisol's shoes...</h3>,
        description: (
          <>
            <p>
              You drop your two children, Mateo and Sofia off at their public school, where{" "}
    ...
    section6: {
      ...
      content: [
        <>
          <p>
            After school, Mateo and Sofia sit down to complete <span className="visual-break" /> their homework on the
    ...
    section8: {
      ...
      content: [
        <>
          ...
          <p>
            <strong>
              “I want Mateo and Sofia to be able to do their <span className="visual-break" /> homework for tomorrow,
    ...
    section10: {
      ...
      option1content: [
        <>
          ...
          <p>
            They said "my area" I wonder about other areas... <span className="visual-break" /> You decide to check the
            provider’s website and enter <span className="visual-break" /> an address in a wealthier, predominantly
          ...
          <p>
            A reliable internet connection is essential for Marisol and <span className="visual-break" /> her children to help with
    ...
    section11: {
      ...
      content: [
        <>
          ...
          <ul>
            <li>
              Marisol’s neighborhood has been digitally redlined, <span className="visual-break" /> meaning internet
        ...
        <ul>
          ...
          <li>
            Because Marisol’s community faces reduced <span className="visual-break" /> access to high-speed internet,
    ...
    section12: {
      image: assets.marisolScenario1Bg10,
      content: [
        <>
          <p className="headingTitleMedium" style={{ color: 'var(--color-white)', fontWeight: 700 }}><center>Let's Reflect...</center></p>
          <br />
          <div className="container">
            <p>
            ...
            <br />
            <p>
              How would this situation impact your daily life, if Mateo and Sofia consistently experienced unreliable
  ...
  scenario2: {
    section1: {
      ...
      content: (
        <h1>
          <span>Marisol receives a mortgage marketing flyer in the mail</span>
        </h1>
      ),
      image: assets.scenario2Bg1,
    },
    section2: {
      sectionTitle: "Marisol Receives a Mortgage Flyer",
      content: (
        <>
          <h2>
    ...
    section3: {
      ...
      content: {
        title: (
          <p>
            You sit at the kitchen table, sorting through the day’s <span className="visual-break" /> mail while Mateo
            and Sofia are in the living room <span className="visual-break" /> doing their homework. While flipping
            through a few <span className="visual-break" /> bills and grocery store coupons, your eyes suddenly{" "}
            <span className="visual-break" /> land on a shiny, glossy flyer from the bank:
          </p>
        ),
        description: (
    ...
    section4: {
      ...
      content: [
        <>
          <p>
            You stare at the flyer, your heart tightening. Owning a <span className="visual-break" /> home has always
            been your dream, a place where the <span className="visual-break" /> kids would have stability, space, and
            no more <span className="visual-break" /> landlords sending messages about rent increases.
          </p>
        ...
        options: [
          {
            title: (
              <p className="option-title">
                “I hate wasting money on rent, it just disappears, and a mortgage would mean I’m investing in my
                family’s future. But... with my job situation right now, would they even consider me?”
              </p>
            ),
            description: (
              <p>I should call Uncle Javier. He once mentioned he could potentially help with my downpayment?</p>
            ),
          ...
          },
          {
            title: (
              <p className="option-title">
                “Owning a home could be my way out of this rent trap, but I need to be smart about it. I think I should
    ...
    section6: {
      option1Img: assets.scenario2Option1,
      option2Img: assets.scenario2Option2,
      option1content: [
        <>
          ...
          <p>
            <strong>This flyer has reignited your dream. One way or another, you're determined to get there.</strong>
          </p>
        </>,
      ],
      option2content: [
        <>
          <div className="headingTitleMedium">Result</div>
          <p>You seriously consider homeownership, seeking advice <span className="visual-break" />
            from a professional.</p>
          <p>
            <strong>This flyer has reignited your dream. One way <span className="visual-break" />
              or another, you're determined to get there.</strong>
          </p>
        </>,
      ],
    },
        ...
        <>
          ...
          <p>
            <strong>
              ...
              than ever. Marisol shares this sentiment.
            </strong>
          </p>
        </>,
      ],
    ...
    section11: {
      ...
      content: {
        description: (
          <>
            <p>
              Later that evening, after putting Mateo and Sofia to bed, you’re back at the kitchen table with your
              laptop open. You just have so many questions, you’ve never bought a home before!
            </p>
            <p>
              {" "}
              Would my savings be enough for a down payment? Would the monthly mortgage payments be lower than rent? And what kind of intereset rate would I qualify for? I don't event know how banks determine interest rates...
            </p>
          </>
        ),
    ...
    section12: {
      ...
      content: (
        <>
          ...
          <p>
            <strong>"Even if my credit is good, what kind of interest rate will I be eligible for?"</strong>
          </p>
        </>
      ),
      onClickReveal: () => {
    ...
    section13: {
      video: assets.scenario2BuildingVideo,
      content1: [
        <>
        ...
        <ul>
          <li>
            ...
            exclusionary lending practices, such as rental <span className="visual-break" />
            payment history or a reliance on cash-based <span className="visual-break" />
            financial habits. Even if someone is financially <span className="visual-break" />
            responsible, a lack of credit history can make it <span className="visual-break" />
            harder to qualify for a mortgage under current <span className="visual-break" />
            lending standards.
          </li>
          <li>
            ...
            <strong>higher median interest rates</strong> compared to white <span className="visual-break" />
            homeowners earning $30,000 or less.
          </li>
        </ul>,
        <>
          <ul>
            <li>
              ...
              incur higher closing costs compared to white <span className="visual-break" />
          ...
          <p>
            <strong>
              These studies show that some people face unfair <span className="visual-break" />
  ...
  scenario3: {
      ...
      content: {
        title: (
          <p className="headingTitleSmall">
            ...
            spend days researching <span className="visual-break" />
            homeownership, mortgages, <span className="visual-break" />
        ...
        description: (
          <p>
            ...
            path to stability for you and your two <span className="visual-break" />
            kids.
          </p>
        ),
      },
    ...
    section4: {
      ...
      firstContent: (
        <>
          ...
          Javier has offered a gift for the downpayment and/or <span className="visual-break" />
      ...
      content: [
        <>
          ...
          <p>
            ...
            mortgage options. I’ve been renting for years and <span className="visual-break" />
            really want to buy a home now. I work full-time and <span className="visual-break" />
            have some savings, plus my uncle is willing to help <span className="visual-break" />
            with some of the costs.”
          </p>
          <p>
            <strong>
              Richard observes Marisol and her surroundings <span className="visual-break" />
              before replying...
            </strong>
          </p>
          <p>
        ...
        options: [
          ...
          },
          {
            ...
            description: (
              <>
                <p>
                  “Wait. I haven’t even shared my finances yet. I have some savings, I pay my rent on time, and I’m
    ...
    section8: {
      option1content: [
        <div>
          Let's now <strong>jump into the shoes of Richard,</strong> <span className="visual-break" />
          and look at his perspective...
        </div>,
        <>
          <p>Marisol looks defeated...</p>
          <p>
            <strong>“…So, it’s not possible for me?”</strong>
          </p>
        ...
        cards: [
          {
            ...
            backContent: (
              <>
                ...
                <p>
                  Richard is making assumptions about her eligibility without exploring options, effectively
                  preemptively dismissing her application.
                </p>
              </>
            ),
          },
          {
            ...
            backContent: (
              <>
                ...
                <p>
                  Richard is discouraging Marisol from applying without giving her practical solutions or informing her
          ...
          },
          {
            ...
            backContent: (
              <>
                ...
                <p>Richard is pushing Marisol to take a more expensive loan option.</p>
              </>
            ),
          },
        ],
    ...
    section11: {
      video: assets.scenario3BuildingTrafficVideo,
      content1: [
        <>
          <div className="headingTitleMedium">Let's reflect</div>
          <div>
        ...
        <>
          ...
          <div>
            <p>
              Take a moment to consider how Marisol might be feeling. What resources or people could help her see that she
              still has options?
            </p>
          </div>
        </>,
      ...
      content2: [
        <>
          ...
          <ul>
            <li>
              Marisol is not being given a fair opportunity to <span className="visual-break" />
              purchase a home.
            </li>

            <li>
              Richard failed Marisol, not because she wasn’t <span className="visual-break" />
              qualified, but because of his own stereotypes and <span className="visual-break" />
              assumptions.
            </li>

            <li>
              Richard dismissed Marisol too quickly based on a <span className="visual-break" />
              first impression, leading to assumptions about her <span className="visual-break" />
              qualifications. This left Marisol feeling dismissed <span className="visual-break" />
              and inferior.
            </li>
          </ul>
          <p>
            Instead of helping to support her dream of <span className="visual-break" />
            homeownership...
          </p>
          <p>
            <strong>He turned her away.</strong>
          </p>
        </>,
        <>
          ...
          <ul>
            ...
            <li>
              ...
              instead of dismissing Marisol, taken the time to <span className="visual-break" />
              explore solutions that fit her needs.
            </li>
            <li>
              <strong>
              ...
              have connected Marisol with those resources.
            </li>
          </ul>
        </>,
        <ul>
  ...
  scenario4: {
      ...
      content: {
        ...
        description: (
          <p>
            ...
            people like Marisol aren't given fair access to <span className="visual-break" />
            opportunities.
          </p>
        ),
      },
      ...
      content: [
        ...
        <>
          <p>
            ...
            unconscious stereotypes so that we can avoid <span className="visual-break" />
    ...
    section9: {
      ...
      contentWithDownload: (onDownload, hasDownloaded) => [
        ...
        <>
          <h2 className="headingTitleSmall">Thank you for completing <span className="visual-break" />this module.</h2>
          <p>
            Before you go, make sure to download your
            <br />
            <strong>Reflective PDF: Part 1 — Building Behaviours.</strong>
